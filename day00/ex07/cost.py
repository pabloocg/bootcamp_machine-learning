...
def cost_(y, y_hat):
    ...
    None if there is a dimension matching problem between X, Y or theta. Raises:
    This function should not raise any Exception.
    """
    elem = cost_elem_(y, y_hat)
    return None if elem is None else np.sum(elem, dtype=float, axis=0)
